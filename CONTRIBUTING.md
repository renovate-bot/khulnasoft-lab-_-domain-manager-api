...
issue](https://github.com/khulnasoft-lab/domain-manager-api/issues) in this
...
request](https://github.com/khulnasoft-lab/domain-manager-api/pulls), you will
...
```console
cd domain-manager-api
pyenv virtualenv <python_version_to_use> domain-manager-api
pyenv local domain-manager-api
